...
def test_cm_raw_keys(cm_raw):
    ...
    """
    youtube_keys = [
        'added_at', 'artist_covers', 'artist_images', 'artist_name',
        'artist_names', 'cm_artist', 'cm_track', 'code2s', 'id',
        'image_url', 'isrc', 'name', 'peak_date', 'peak_rank',
        'position', 'pre_rank', 'rankStats', 'raw_data', 'time_on_chart',
        'view_count', 'youtube_artist', 'youtube_artist_ids',
        'youtube_artist_names', 'youtube_track_id', 'youtube_track_ids',
        ]

    apple_keys = [
        'added_at', 'album_ids', 'album_label', 'album_names',
        'album_upc', 'artist_covers', 'artist_images', 'artist_names',
        'cm_artist', 'cm_track', 'code2', 'code2s', 'composer_name',
        'country', 'id', 'image_url', 'isrc', 'itunes', 'itunes_album_id',
        'itunes_album_ids', 'itunes_artist_ids', 'itunes_artist_names',
        'itunes_track_ids', 'name', 'peak_date', 'peak_rank', 'pre_rank',
        'rank', 'rankStats', 'release_dates', 'storefronts', 
    ...
    itunes_keys = [
        ...
        'album_upc', 'artist_covers', 'artist_images', 'artist_names',
        'cm_artist', 'cm_track', 'code2', 'code2s', 'composer_name',
        'genre', 'id', 'image_url', 'isrc', 'itunes', 'itunes_album_id',
        'itunes_album_ids', 'itunes_artist_ids', 'itunes_artist_names',
        'itunes_track_ids', 'name', 'peak_date', 'peak_rank', 'pre_rank',
        'rank', 'rankStats', 'release_dates', 'storefronts', 
        'time_on_chart', 'track_genre'
    ...
    shazam_keys = [
        'added_at', 'album_ids', 'album_label', 'album_names',
        'album_upc', 'artist_covers', 'artist_images', 'artist_names',
        'city', 'cm_artist', 'cm_track', 'code2', 'code2s', 'composer_name',
        'id', 'image_url', 'isrc', 'itunes_album_id', 'itunes_album_ids',
        'itunes_artist_ids', 'itunes_artist_names', 'itunes_id', 
        'itunes_track_ids', 'name', 'num_of_shazams', 'peak_date',
        'peak_rank', 'pre_rank', 'rank', 'rankStats', 'release_dates',
        'shazam_track_id', 'storefronts', 'time_on_chart', 'track_genre'
        ]    
    
    spotify_keys = [
        'added_at', 'album_ids', 'album_label', 'album_names',
        'album_upc', 'artist_covers', 'artist_images', 'artist_names',
        'chart_name', 'chart_type', 'cm_artist', 'cm_track', 'code2',
        'code2s', 'current_plays', 'duration', 'id', 'image_url', 'isrc',
        'name', 'peak_date', 'peak_rank', 'pre_rank', 'rank', 'rankStats',
        'release_dates', 'spotify', 'spotify_album_id', 'spotify_album_ids',
        'spotify_artist_ids', 'spotify_artist_names', 'spotify_duration_ms',
        'spotify_popularity', 'spotify_track_ids', 'time_on_chart', 
        'track_genre'
        ]
...
def test_parse_charts(cm_raw):
    ...
    """
    youtube_keys = [
        'added_at', 'artist_covers_1', 'artist_images_1',
        'artist_name', 'artist_names_1', 'cm_artist_1',
        'cm_track', 'code2s_1', 'id', 'image_url', 'isrc',
        'name', 'peak_date', 'peak_rank', 'position', 'pre_rank',
        'rank_1d_ago', 'rank_today', 'percent_views_change',
        'time_on_chart', 'view_count', 'youtube_artist',
        'youtube_artist_ids_1', 'youtube_artist_names_1',
        'youtube_track_id', 'youtube_track_ids_1'
        ]

    apple_keys = [
        'added_at', 'album_ids_1', 'album_label_1', 'album_names_1',
        'album_upc_1', 'artist_covers_1', 'artist_images_1',
        'cm_track', 'artist_names_1', 'cm_artist_1',  'code2',
        'code2s_1', 'itunes', 'composer_1', 'country', 'id',
        'image_url', 'isrc', 'name', 'itunes_album_id_1',
        'itunes_album_ids_1', 'itunes_artist_ids_1', 
        'itunes_artist_names_1', 'itunes_track_ids_1', 'peak_date', 
        'peak_rank', 'pre_rank', 'rank', 'rank_1d_ago',
        'rank_today', 'release_dates_1', 'storefronts_1',
        'time_on_chart', 'track_genre_1'
        ]
    ...
    itunes_keys = [
        ...
        'album_upc_1', 'artist_covers_1', 'artist_images_1',
        'cm_track', 'artist_names_1', 'cm_artist_1', 'code2',
        'code2s_1', 'genre', 'composer_1', 'id', 'image_url',
        'isrc', 'itunes', 'itunes_album_id_1', 'itunes_album_ids_1',
        'itunes_artist_ids_1', 'itunes_artist_names_1',
        'itunes_track_ids_1', 'name', 'peak_date', 'peak_rank',
        'pre_rank', 'rank', 'rank_1d_ago', 'rank_today', 
        'release_dates_1', 'storefronts_1', 'time_on_chart',
        'track_genre_1'
        ]  
    ...
    shazam_keys = [
        'added_at', 'album_ids_1', 'album_label_1', 'album_names_1', 
        'album_upc_1', 'artist_covers_1', 'artist_images_1',
        'cm_track', 'artist_names_1', 'city', 'cm_artist_1', 'code2',
        'code2s_1', 'composer_1', 'id', 'image_url', 'isrc',
        'itunes_album_id_1', 'itunes_album_ids_1',
        'itunes_artist_ids_1', 'itunes_artist_names_1', 'itunes_id',
        'itunes_track_ids_1', 'name', 'num_of_shazams', 'peak_date', 
        'peak_rank', 'pre_rank', 'rank', 'rank_1d_ago', 'rank_today',
        'release_dates_1', 'shazam_track_id', 'storefronts_1',
        'time_on_chart', 'track_genre_1'
        ]    
    ...
    spotify_keys = [
        ...
        'cm_track', 'code2', 'code2s_1', 'current_plays', 'duration',
        'id', 'image_url', 'isrc', 'name', 'peak_date', 'peak_rank',
        'pre_rank', 'rank', 'rank_1d_ago', 'rank_today',
        'plays_1d_ago', 'plays_today', 'release_dates_1', 'spotify',
        'spotify_album_id', 'time_on_chart', 'spotify_album_ids_1',
        'spotify_artist_ids_1', 'track_genre_1', 
        'spotify_artist_names_1', 'spotify_duration_ms',
        'spotify_popularity', 'spotify_track_ids_1'
        ]
